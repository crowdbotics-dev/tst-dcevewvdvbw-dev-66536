...
## Project Structure
    ...
    ├── tst_dcevewvdvbw_dev_66536  # Django project configurations
...
1. Clone this repo and `cd tst_dcevewvdvbw_dev_66536`
...
2. Clone this repo and `cd tst_dcevewvdvbw_dev_66536`
